...
//What happens if you input something that is not an integer?
        ...
        Integer userInput = Integer.valueOf(scanner.nextInt());
...
//4.Rewrite the above example using the nextLine method.
        ...
        String userSentence2 = scanner4.nextLine();
        System.out.printf("You have entered: %s%n", userSentence2);
...
//The area of a rectangle is equal to the length times the width, and the perimeter of a rectangle is equal to 2 times the length plus 2 times the width.
        ...
        double length = Double.parseDouble(scanner6.nextLine());
        ...
        System.out.printf("The classroom has an area of: %f and a perimeter of: %f%n",  areaOfClassroom,
                perimeterOfClassroom);
